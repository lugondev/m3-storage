...
const MediaModal = ({trigger, open, onOpenChange}: MediaModalProps) => {
		...
		<Dialog open={open} onOpenChange={onOpenChange}>
			...
			<DialogContent className='max-w-7xl max-h-[90vh] overflow-y-auto'>
				<DialogHeader>
					...
					<DialogDescription>Manage your media files - upload, view, and organize your content.</DialogDescription>
				</DialogHeader>
